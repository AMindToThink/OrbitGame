...
class Enemy extends Point{
   ...
   //Faces
   public transient BufferedImage face = null;
   public int imageExtraX;
   public int imageExtraY;
   public int imageFacePlayerX;
   public int imageFacePlayerY;
   
   public transient static BufferedImage daveFace = null;
   public transient static BufferedImage simpleFace = null;
   public transient static BufferedImage weinbergFace = null;
   public transient static BufferedImage wallFace = null;
   ...
   public static int wallDiameter = 30;
   public boolean imageDrift = true;
   
   //Boss score
   public int spawnScore = -1;
   public boolean isBoss = false;
   public Drop bossDrop = null;
   ...
   public static void setUp(){
      ...
      try{
         ...
         wallFace = ImageIO.read(new File("TRUMP.png"));
         wallFace = helpful.resize(wallFace, wallDiameter, wallDiameter);
   ...
   //constructor
   public Enemy(String type, int x, int y, double masterSpeed, double refreshTime){
      super(x,y, 10, Color.BLACK);
      creationTime = CircleOrbitMouse.myTimerThread.myClock.millis();
      enemyPlayerAngle = helpful.findAngle(CircleOrbitMouse.playerPoint.getX()-x,CircleOrbitMouse.playerPoint.getY()-y);
      this.x=x;
      this.y=y;
      this.trueX=x;
      this.trueY=y;
      ...
      if(this.type.equals("Stationary")){
         diameter=30;
         damage = -1;
      ...
      if(this.type.equals("TLessQueen")){
         pointValue=30;
         diameter=30;
         damage = -1;
         color=queenColor;
      ...
      if(this.type.equals("TLessRook")){
         pointValue=20;
         diameter=30;
         damage = -1;
         color=rookColor;
         simpleEnemySpeed=masterSpeed/8;
      }
      if(this.type.equals("TLessBishop")){
         pointValue=20;
         diameter=30;
         damage = -1;
         color=bishopColor;
      ...
      if(this.type.equals("Strong Simple")){
         pointValue=10;
         color=simpleColor;
         simpleEnemySpeed=masterSpeed/15;
         diameter=30;
      ...
      if(this.type.equals("Simple Ranged")){
         pointValue=50;
      ...
      if(this.type.equals("Strong Shooter")){
         pointValue=100;
         color=simpleRangedColor;
         simpleEnemySpeed=masterSpeed/15;
         diameter=30;
      ...
      if(this.type.equals("Primal Aspid")){
         pointValue=100;
         color=simpleRangedColor;
         simpleEnemySpeed=masterSpeed/15;
         diameter=30;
      ...
      if(this.type.equals("Speed Sentry")){
         pointValue=30;
         color=simpleRangedColor;
         simpleEnemySpeed=masterSpeed/15;
         diameter=60;
      ...
      if(this.type.equals("Strong Projectile")){
         pointValue = 0;
         color = Color.ORANGE;
         simpleEnemySpeed = masterSpeed/2;
         diameter = 10;
      ...
      if(this.type.equals("GProjectile")){
         pointValue = 0;
        // int rR = (int)(Math.random()*256);
        // int rG = (int)(Math.random()*256);
         //int rB = (int)(Math.random()*256);
      ...
      if(this.type.equals("Momcolm")){
         pointValue=200;
         spawnScore = 500;
         isBoss = true;
         bossDrop = new Drop(0,0, "Malcolm");
         color=simpleColor;
         simpleEnemySpeed=masterSpeed/7;
         diameter=100;
         damage = -2;
      ...
      if(this.type.equals("MomcolmSpawn")){
         pointValue=50;
         color=simpleRangedColor;
         simpleEnemySpeed=masterSpeed/15;
         diameter=30;
      ...
      if(this.type.equals("Weinberg")){      
         spawnScore = 5000;
         isBoss = true;
         bossDrop = new Drop(0,0, "Tangent");
         pointValue=1000;
         imageDrift = false;
      ...
      if(this.type.equals("RandLaser")){
         //laserList.add(new Laser("Angle",this, 0, this.getColor(), 30, 5000, 00, 0));
         double randAngle = Math.random()*2*Math.PI;
         laserList.add(new Laser("Angle",this, randAngle, this.getColor(), 30, 5000, 00, 0));
         //laserList.add(new Laser("Angle",this, Math.PI, this.getColor(), 30, 5000, 00, 0));
         //laserList.add(new Laser("Angle",this, 3*Math.PI/2.0, this.getColor(), 30, 5000, 00, 0));
         pointValue=30;
         color=simpleRangedColor;
         simpleEnemySpeed=masterSpeed/15;
         diameter=30;
      ...
      if(this.type.equals("SentryLaser")){
         //laserList.add(new Laser("Angle",this, 0, this.getColor(), 30, 5000, 00, 0));
         double randAngle = Math.random()*2*Math.PI;
         laserList.add(new Laser("Angle",this, randAngle, this.getColor(), 30, 5000, 00, 0));
         //laserList.add(new Laser("Angle",this, Math.PI, this.getColor(), 30, 5000, 00, 0));
      ...
      if(this.type.equals("LaserAspid")){
         //laserList.add(new Laser("Angle",this, 0, this.getColor(), 30, 5000, 00, 0));
         double randAngle = Math.random()*2*Math.PI;
         laserList.add(new Laser("Angle",this, enemyPlayerAngle-Math.PI/8, this.getColor(), 30, 5000, 00, 0));

         laserList.add(new Laser("Angle",this, enemyPlayerAngle, this.getColor(), 30, 5000, 00, 0));
         laserList.add(new Laser("Angle",this, enemyPlayerAngle+Math.PI/8, this.getColor(), 30, 5000, 00, 0));
      ...
      if(this.type.equals("RotateLaser")){
         double randAngle = Math.random()*2*Math.PI;

         laserList.add(new Laser("Angle",this, randAngle, this.getColor(), 30, 1000, 00, 0));
      ...
      if(this.type.equals("Dreadnought")){ 
        // laserList.add(new Laser("Normal",this, CircleOrbitMouse.playerPoint, this.getColor(), 30, 00, 0)); 
         laserList.add(new Laser("Angle",this, Math.PI/2, this.getColor(), 30, 5000, 00, 0)); 
         laserList.add(new Laser("Angle",this, -Math.PI/2, this.getColor(), 30, 5000, 00, 0)); 
         laserList.add(new Laser("Angle",this, Math.PI, this.getColor(), 30, 5000, 00, 0));
         laserList.add(new Laser("Angle",this, 0, this.getColor(), 30, 5000, 00, 0));
         movesOnPlayer = true;
         ...
         spawnScore = 10000;
         isBoss = true;
         bossDrop = new Drop(0,0, "Screensaver");
         pointValue=5000;
         imageDrift = false;
         
         color=simpleColor;
         simpleEnemySpeed=masterSpeed/10;
         diameter=(int)(CircleOrbitMouse.FRAME_WIDTH*1.5);
         //face = weinbergFace;
         damage = -2;
         maxHealth = (int)(100000/refreshTime);
         health = maxHealth;
   ...
   public void attack(int playerLocationX,int playerLocationY, int playerDiameter, int playerHealths, boolean playerInvincible, int weaponLocationX, int weaponLocationY, int weaponDiameter){
      ...
      if (movesOnPlayer || x != playerLocationX || y != playerLocationY){
         ...
         */
            setVector(0,0);
            //I did this with angles, but the angles around Math.PI do not seem to work properly
            System.out.println(enemyPlayerAngle/Math.PI + " pi");
            if(Math.round(Math.abs(playerLocationX-x))!=Math.round(Math.abs(playerLocationY-y)) && 
            ((enemyPlayerAngle > Math.PI/3 && enemyPlayerAngle < 2*Math.PI/3)
            ||((enemyPlayerAngle>=0 && enemyPlayerAngle<Math.PI/6) 
            || (enemyPlayerAngle>11*Math.PI/6 && enemyPlayerAngle <= Math.PI*2)) 
            || (enemyPlayerAngle<7*Math.PI/6 && enemyPlayerAngle>5*Math.PI/6) 
            || (enemyPlayerAngle > 4*Math.PI/3 && enemyPlayerAngle < 5*Math.PI/3))){
            
               if(Math.abs(playerLocationX-x)>Math.abs(playerLocationY-y)){
                  if(playerLocationX>x){
                     setVector((int)helpful.xConsVector(x,y,(int)(x+simpleEnemySpeed),y, simpleEnemySpeed),0);
                  }else{
                     setVector(-(int)helpful.xConsVector(x,y,(int)(x+simpleEnemySpeed),y, simpleEnemySpeed),0);
                  }
               }else if(Math.abs(playerLocationX-x)<Math.abs(playerLocationY-y)){
                  if(playerLocationY>y){
                     setVector(0,(int)helpful.yConsVector(x,y,x,(int)(y+simpleEnemySpeed), simpleEnemySpeed));
                  }else{
                     setVector(0,-(int)helpful.yConsVector(x,y,x,(int)(y+simpleEnemySpeed), simpleEnemySpeed));
                  }
         ...
         */
           ...
           // }
           setVector(0,0);
           if((x!=playerLocationX && y!=playerLocationY)&&!((enemyPlayerAngle > Math.PI/3 && enemyPlayerAngle < 2*Math.PI/3)
            ||((enemyPlayerAngle>=0 && enemyPlayerAngle<Math.PI/6) 
            || (enemyPlayerAngle>11*Math.PI/6 && enemyPlayerAngle <= Math.PI*2)) 
            || (enemyPlayerAngle<7*Math.PI/6 && enemyPlayerAngle>5*Math.PI/6) 
            || (enemyPlayerAngle > 4*Math.PI/3 && enemyPlayerAngle < 5*Math.PI/3))){
              ...
              if(x<playerLocationX){
                 ...
                 changeVector(simpleEnemySpeed, 0);
              }else{
                  changeVector(-simpleEnemySpeed,0);
              }
              if(y<playerLocationY){
                 changeVector(0,simpleEnemySpeed);
              }else{
                 changeVector(0,-simpleEnemySpeed);
              }
           }     
         ...
         */
            ...
            if(playerNotMoving){
               simpleEnemySpeed= masterSpeed/5;
               changeXY(( (xToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))),
                    ( (yToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))) );
         ...
         */
         ...
         if(this.type.equals("Rboo")){
            ...
            color=rBooColor;
         */
            if((helpful.findDistance(x,y,playerLocationX,playerLocationY)>helpful.findDistance(x,y,playerLocationX+CircleOrbitMouse.playerPoint.getXVector(), playerLocationY+CircleOrbitMouse.playerPoint.getYVector()))/* || rememberPlayerY!=0&&rememberPlayerX!=0&&(findDistance(playerLocationX, playerLocationY, x, y)<findDistance(rememberPlayerX, rememberPlayerY, x, y))*/){
               //simpleEnemySpeed=masterSpeed/5;
               setVector(( (xToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))),
                    ( (yToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))) );
         ...
         */
         ...
         if(this.type.equals("Simple") || this.type.equals("Strong Simple")){
            setVector(( (xToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))),
                   ( (yToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))) );
         ...
         if(this.type.equals("Simple Ranged") || this.type.equals("G Across") || this.type.equals("MomcolmSpawn") || this.type.equals("LaserAspid")){
            /*
            pointValue=30;
            color=simpleRangedColor;
            double simpleEnemySpeed=masterSpeed/15;
            ...
            */
            ...
            int maxShootingRange=260;
            if(findDistance(playerLocationX, playerLocationY, this.x,this.y)<=minShootingRange){
               setVector(-( (helpful.xConsVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed))),
                   -( (helpful.yConsVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed))) );
         ...
         if(this.type.equals("Projectile") || this.type.equals("Strong Projectile")){   
         ...
         if(this.type.equals("RotateLaser")){
            for(Laser l : laserList){
               if(l.laserEnded){
                  l.laserEnded = false;
                  l.setAngle(l.getAngle()+Math.PI/10);
               }
            }
         }
         if(this.type.equals("LaserAspid")){
            for(int l = 0; l<laserList.size(); l++){
               if(laserList.get(l).laserEnded){
                  laserList.get(l).laserEnded = false;
                  laserList.get(l).setAngle(enemyPlayerAngle-l*Math.PI/8+Math.PI/8);
               }
            }
         }
         if(this.type.equals("Dave") || this.type.equals("Momcolm")){
            setVector(( (xToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))),
                   ( (yToStraightVector(this.x, this.y, playerLocationX, playerLocationY,simpleEnemySpeed,"towards",false, 10))) );
         }
         if(this.type.equals("Dreadnought")){
            int stTargetX = CircleOrbitMouse.FRAME_WIDTH/2;
            int stTargetY = (int)(-CircleOrbitMouse.FRAME_HEIGHT);
           // if(!((int)x == stTargetX && (int)y == stTargetY)){
            setVector(( (helpful.xConsVector(this.x, this.y, stTargetX, stTargetY,simpleEnemySpeed))),
                    ( (helpful.yConsVector(this.x, this.y, stTargetX, stTargetY,simpleEnemySpeed))) );
   ...
   public boolean laserListDamaging(){
      for(Laser l : laserList){
         if(l.laserCollision(playerLocationX, playerLocationY, playerDiameter)){
            return true;
         }
      }
      return false;
   ...
   public boolean isDamaging(int playerLocationX,int playerLocationY, int playerDiameter, boolean playerInvincible){
      if(!playerInvincible&&(findDistance(playerLocationX, playerLocationY, this.x,this.y)<=diameter/2+playerDiameter/2 || laserListDamaging())){
            ////System.out.println("hit");
         ...
         if(this.type.equals("Trail")&&!playerInvincible){
            for(int k=0; k<enemyTrail.getTrailListSize(); k++){
   ...
   public void doSwoop(int swoopMinDistance, int swoopMaxDistance){   
      ...
      if(!isInSwoop&&enemyPlayerDistance > swoopMaxDistance){
         ...
         setVector(helpful.xConsVector(x,y,targetX,targetY, simpleEnemySpeed),helpful.yConsVector(x,y,targetX,targetY, simpleEnemySpeed));
        
         if(this.x==targetX&&this.y==targetY){
            isInSwoop=false;
            swoop=false;
            setTarget(0,0);
            //System.out.println("This Broke it");
         }
   ...
   public void swoopAndBack(double speed, int swoopMinDistance, int swoopMaxDistance){
      ...
      if(!isBackSwoop && !isInSwoop&enemyPlayerDistance > swoopMaxDistance){
         simpleEnemySpeed=speed;
         setVector(helpful.xConsVector(x,y,playerLocationX,playerLocationY, simpleEnemySpeed),helpful.yConsVector(x,y,playerLocationX,playerLocationY, simpleEnemySpeed));
         ...
         setVector(helpful.xConsVector(x,y,targetX,targetY, simpleEnemySpeed),
                    helpful.yConsVector(x,y,targetX,targetY, simpleEnemySpeed) );
         if(this.x==targetX&&this.y==targetY){
            isInSwoop=false;
            swoop=false;
            isBackSwoop=true;
   ...
   public void camera(boolean north, boolean east, boolean south, boolean west, int playerVectorX, int playerVectorY){
      if(doesCamera){
         ...
         if(north){
            ...
            if(type.equals("Nboo")||type.equals("Boo")||type.equals("Rboo")||type.equals("Aboo")){
